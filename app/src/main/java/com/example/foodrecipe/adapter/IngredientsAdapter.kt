...
import com.example.foodrecipe.databinding.IngredientsItemLayoutBinding
...
class IngredientsAdapter: RecyclerView.Adapter<IngredientsAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(IngredientsItemLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
